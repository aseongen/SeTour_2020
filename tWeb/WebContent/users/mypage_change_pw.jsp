<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<% //마이페이지는 로그인 한 사람만 들어올 수 있다 . 
//user_name 세션을 가진 사람만 들어올 수 있음
...
<ul class="nav nav-tabs nav-justified">
   <li class="nav-item" ><a class="nav-link active" href="/setour/users/mypage_change_pw.jsp" style="font-size: 20px;"><strong>비밀번호 변경</strong></a></li>
   ...
   <li class="nav-item"><a class="nav-link" href="/setour/users/mypage_delete_check.jsp" style="font-size: 20px;"><strong>회원 탈퇴하기</strong></a></li>
   
</ul>
<br/><br/>

<h4 style="color: #9397fa;">비밀번호 변경 페이지</h4><hr/><br/>
...
<table style="cellpadding: 0; cellspacing: 0; margin: 0 auto; width: 100%">
	...
	<tr>
		...
		<input type="submit" value="변경" class="btn form-control tooltipstered" id="change_pw_btn"
			style="background-color: #fccc26; margin-top: 0; height: 40px; color: white; border: 0px solid #f78f24; opacity: 0.8">
		</td>
	</tr>
</table>
</form>
